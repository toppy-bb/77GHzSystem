...
# plotdata
ax1.scatter(g1/g0, g2/g0, g3/g0,  vmin=-(np.pi), vmax=np.pi, s=8)
ax4.scatter(h1/h0, h2/h0, h3/h0,  vmin=-(np.pi), vmax=np.pi, s=8)
ax2.scatter(m1/m0, m2/m0, m3/m0,  vmin=-(np.pi), vmax=np.pi, s=8)
ax5.scatter(n1/n0, n2/n0, n3/n0,  vmin=-(np.pi), vmax=np.pi, s=8)
ax3.scatter(l1/l0, l2/l0, l3/l0,  vmin=-(np.pi), vmax=np.pi, s=8)
ax6.scatter(r1/r0, r2/r0, r3/r0,  vmin=-(np.pi), vmax=np.pi, s=8)
